...
def fetch_contact_data():
    ...
    contact_us_ref = db.collection('AIPro_email_notify')
...
def fetch_sent_data():
    ...
    sent_data_ref = db.collection('AIPro_email_sent_data')
...
def send_email(contact_data, sent_data):
    ...
    msg['Subject'] = 'New Contact Request from AIProStack Solutions Website'
...
def fetch_email_sent_to_user():
    ...
    email_sent_to_user_ref = db.collection('AIPro_email_sent_to_user')
...
def send_confirmation_email(email, name):
    ...
    msg['From'] = smtp_username
    msg['To'] = email
    msg['Subject'] = 'Thank You for Contacting AIProStack Solutions'
